...
export const infoEvent = {
 ...
 export const FORMATS_CUSTOMIZED_BANNERS = [
  ...
  { 
    ...
    logoCenter: [540, 1393], 
    standLetterPosition: [1080-31, 1403], 
    maxLogoSize: [200, 64], 
    font: '32px dico-mono' 
  },
  { 
