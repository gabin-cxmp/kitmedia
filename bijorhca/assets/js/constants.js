...
export const infoEvent = {
 ...
 export const FORMATS_CUSTOMIZED_BANNERS = [
  { 
    ...
    logoCenter: [540, 1033], 
    standLetterPosition: [1080-28, 1074], 
    maxLogoSize: [200, 64], 
  ...
  { 
    ...
    logoCenter: [540, 1873], 
    standLetterPosition: [1080-28, 1913], 
    maxLogoSize: [200, 64], 
    font: '32px NueueHaasDisplayMedium' 
  },
  { 
    ...
    logoCenter: [540, 1303], 
    standLetterPosition: [1080-28, 1344], 
    maxLogoSize: [200, 64], 
    font: '32px NueueHaasDisplayMedium' 
  },
  { 
    ...
    dimensions: [1584, 396], 
    logoCenter: [792, 361], 
    standLetterPosition: [1584-27, 401], 
    maxLogoSize: [200, 52], 
    font: '32px NueueHaasDisplayMedium'
   },
   { 
